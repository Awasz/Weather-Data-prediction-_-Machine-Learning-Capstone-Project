...
#outer division starts 
  ...
  html.Div([
    #First inner division for adding dropdown helper text for selected Drive wheels
           ...
           #dcc.RadioItems(['NSW','NT','QL','SA','TA','VI''WA']),id ='region',inline=True)]),
...
#Second Inner division for adding 2 inner divisions for 2 output graph 
...
def reg_year_display(input_region, input_year):
    ...
    #Plot one - Monthly Average Estimated Fire Average
